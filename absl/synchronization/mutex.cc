...
const MutexGlobals &GetMutexGlobals() {
  ...
  absl::base_internal::LowLevelCallOnce(&data.once, [&]() {
    ...
    if (num_cpus > 1) {
      ...
      data.mutex_sleep_time =data.mutex_sleep_time<absl::Milliseconds(1)?absl::Milliseconds(1):(data.mutex_sleep_time>absl::Microseconds(10))?absl::Microseconds(10):data.mutex_sleep_time;
    }
  });
  return data;
}
